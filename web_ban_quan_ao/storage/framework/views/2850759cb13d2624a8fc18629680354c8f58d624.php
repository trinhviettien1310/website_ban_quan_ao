...
<div class="card">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-left">
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin')); ?>"> <i class="nav-icon fas fa fa-home"></i> Trang chủ</a></li>
            <li class="breadcrumb-item"><a href="<?php echo e(route('post.index')); ?>">Bài viết</a></li>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            <option value="1" <?php echo e((($post->status=='1')? 'selected' : '')); ?>><?php echo e(_('Hoạt Động')); ?></option>
            <option value="0" <?php echo e((($post->status=='0')? 'selected' : '')); ?>><?php echo e(_('Ngừng Hoạt Động')); ?></option>
        </select>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/backend/post/edit.blade.php ENDPATH**/ ?>