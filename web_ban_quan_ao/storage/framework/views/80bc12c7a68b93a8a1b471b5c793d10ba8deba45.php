...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="<?php echo e(route('supplier.update',$supplier->id)); ?>">
        ...
        <input id="inputTitle" type="text" name="tenncc" placeholder="Nhập tên nhà cung cấp"  value="<?php echo e($supplier->tenncc); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <input id="inputTitle" type="text" name="diachi" placeholder="Nhập địa chỉ"  value="<?php echo e($supplier->diachi); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <input id="inputTitle" type="text" name="phone" placeholder="Nhập số điện thoại"  value="<?php echo e($supplier->phone); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
        ...
        <input id="inputTitle" type="text" name="email" placeholder="Nhập email"  value="<?php echo e($supplier->email); ?>" class="form-control">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/backend/supplier/edit.blade.php ENDPATH**/ ?>