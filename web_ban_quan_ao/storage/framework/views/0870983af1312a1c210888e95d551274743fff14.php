              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Đăng nhập để quản lý hàng</h1>
                  </div>
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="text-center">
                  <p class="text-center">Chưa có tài khoản? <a href="<?php echo e(route('register')); ?>" data-toggle="modal" data-target="#registerModal">Đăng ký</a></p>
                  </div>
                </div>
              </div>
            </div>
...
<?php /**PATH D:\BE2\web_ban_quan_ao\resources\views/auth/login.blade.php ENDPATH**/ ?>