        ...
        <div class="col-12">
            <div class="breadcrumb_content">
                <ul>
                    ...
                    <li><?php echo e($product_detail->cat_info->title); ?> / <?php echo e($product_detail->title); ?></li>
                </ul>
            ...
            <div class="product_tab fix">
                        ...
                        <?php $__currentLoopData = $photo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a data-toggle="tab" href="#p_tab2" role="tab" aria-controls="p_tab2"
                                    aria-selected="false"><img src="<?php echo e($data); ?>" alt=""></a>
                            </li>
                ...
                <div class="tab-content produc_tab_c">
                    ...
                    <div class="tab-pane fade show active" id="p_tab1" role="tabpanel">
                        <div class="modal_img">
                            <a href="#"><img src="<?php echo e($photo[0]); ?>" alt="<?php echo e($photo[0]); ?>"></a>
                            <div class="img_icone">
                                <img src="assets\img\cart\span-new.png" alt="">
                            </div>
                            <div class="view_img">
                                <a class="large_view" href="<?php echo e($photo[0]); ?>"><i class="fa fa-search-plus"></i></a>
                            </div>
                        </div>
                    </div>

                    <?php $__currentLoopData = $photo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="tab-pane fade" id="p_tab2" role="tabpanel">
                            <div class="modal_img">
                                <a href="#"><img src="<?php echo e($data1); ?>" alt=""></a>
                                <div class="img_icone">
                                    <img src="assets\img\cart\span-new.png" alt="">
                                </div>
                                <div class="view_img">
                ...
                <div class="product_ratting mb-10">
                    <div class="product__details__option">
                        <div class="product__details__option__size">
                            ...
                            <?php $__currentLoopData = $size; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sizes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label for="<?php echo e($sizes); ?>"><?php echo e($sizes); ?>

                                    <input type="radio" id="<?php echo e($sizes); ?>">
                                </label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="content_price mb-15">
                        ...
                        <?php if($product_detail->discount != 0): ?>
                            ...
                            <span class="old-price"><?php echo e(number_format($product_detail->price), 2); ?>đ</span>
                        <?php else: ?>
                            <span><?php echo e(number_format($product_detail->price), 2); ?>đ</span>
                        <?php endif; ?>
                    </div>
                    <div class="box_quantity mb-20">
                        <form action="<?php echo e(route('single-add-cart', $product_detail->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>

                            <input min="1" name="quantity" max="max="<?php echo e($product_detail->stock); ?>""
                                value="1" type="number">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="reviews" role="tabpanel">
                        <div class="product_info_content">
                            ...
                            <div class="fb-comments" data-href="<?php echo e($url); ?>" data-width="650"
                                data-numposts="7"></div>
...
<div class="new_product_area product_page">
    ...
    <div class="row">
        <div class="single_p_active owl-carousel">
            <?php $__currentLoopData = $product_relate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="col-lg-3">
                    <div class="single_product">
                        <div class="product_thumb">
                            <a href="<?php echo e(route('product-detail', $product->slug)); ?>"><img src="<?php echo e($photo[0]); ?>"
                                    alt=""></a>
                            <div class="img_icone">
                                <img src="assets\img\cart\span-new.png" alt="">
                            </div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/frontend/pages/product-detail.blade.php ENDPATH**/ ?>