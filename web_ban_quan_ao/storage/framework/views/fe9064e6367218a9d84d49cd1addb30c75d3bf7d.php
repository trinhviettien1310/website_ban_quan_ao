                              ...
                              <div class="header_links">
                                  <ul>
                                      ...
                                      <li><a href="#" title="">
                                          ...
                                          <?php endif; ?>
                                          <?php if(isset(Auth::user()->name)): ?>
                                          <li><a href="" title="Your name">
                                             <h5><?php echo e(Auth::user()->name); ?> </h5>
                                            </a></li>
                                            <li><a href="<?php echo e(route('home')); ?>" title="Đăng xuất">
                                                <?php
                                                Auth::logout()?>
...
<?php /**PATH E:\Ban_quan_ao\web_ban_quan_ao\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>