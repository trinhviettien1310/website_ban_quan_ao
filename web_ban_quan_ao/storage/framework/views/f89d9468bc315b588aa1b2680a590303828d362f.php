            ...
            <div class="form-group">
                ...
                <select name="id_nhacungcap" id="id_nhacungcap" class="form-control">
                    ...
                    <?php $__currentLoopData = $nhacungcap; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value='<?php echo e($data->id); ?>' <?php echo e((($product->id_nhacungcap==$data->id)? 'selected'  : '')); ?>><?php echo e($data->tenncc); ?></option>
      ...
      <div class="form-group">
        ...
        <select name="condition" class="form-control">
            <option value="">--Chọn tình trạng--</option>
              ...
              <option value="0" <?php echo e((($product->condition=='0')? 'selected':'')); ?>>Mặc Định</option>
              <option value="1" <?php echo e((($product->condition=='1')? 'selected':'')); ?>>Mới</option>
              <option value="2" <?php echo e((($product->condition=='2')? 'selected':'')); ?>>Hot</option>
        </select>
      </div>
    </div>
    ...
    <div class="col-4">
      <div class="form-group">
        ...
        <select name="status" class="form-control">
            <option value="1" <?php echo e((($product->status=='1')? 'selected' : '')); ?>>Kinh Doanh</option>
            <option value="0" <?php echo e((($product->status=='0')? 'selected' : '')); ?>>Ngừng Kinh Doanh</option>
        </select>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/backend/product/edit.blade.php ENDPATH**/ ?>