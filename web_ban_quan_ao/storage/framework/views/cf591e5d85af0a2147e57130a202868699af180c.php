...
<?php $__env->startSection('title','Liên Hệ Gille'); ?>
    ...
    <div class="row">
           <div class="col-lg-6 col-md-12">
               <div class="contact_message">
                    ...
                    <form  action="<?php echo e(route('post-contact')); ?>" id="contact-form" method="POST">
           ...
           <div class="col-lg-6 col-md-12">
               <div class="contact_message contact_info">
                    ...
                    <ul>
                        <li><i class="fa fa-fax"></i>  Địa chỉ : <?php echo e($setting->address); ?></li>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>