...
<?php $__env->startSection('main-content'); ?>
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="<?php echo e(route('product.create')); ?>" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i>Thêm Mới</a>
    </div>
    <div class="card-body">
            ...
            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              ?>
                <tr>
                    ...
                    <td><?php echo e(number_format($product->price),2); ?>VNĐ</td>
                    ...
                    <td>
                        <?php if($product->status=='1'): ?>
                            <span class="badge badge-success"><?php echo e(_('Kinh Doanh')); ?></span>
                        <?php else: ?>
                            <span class="badge badge-warning"><?php echo e(_('Ngừng Kinh Doanh')); ?></span>
                        <?php endif; ?>
                    </td>
                    <td>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/backend/product/index.blade.php ENDPATH**/ ?>