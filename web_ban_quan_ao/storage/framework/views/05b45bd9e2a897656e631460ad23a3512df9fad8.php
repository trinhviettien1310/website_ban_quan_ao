                              ...
                              <div class="header_links">
                                  <ul>
                                         ...
                                         <!-- Nếu chưa đăng nhập -->
                                          ...
                                          <li><a href="<?php echo e(route('login-user')); ?>" title="Đăng nhập">
                                          ...
                                          <?php if(isset(Auth::user()->name)): ?>
                                          <li><a href="" title="<?php echo e(Auth::user()->name); ?> ">
                                             <h5><?php echo e(Auth::user()->name); ?> </h5>
                                            </a></li>
                                            <li><a href="<?php echo e(route('signout')); ?>" title="Đăng xuất">
                  ...
                  <div class="header_middel">
                      <div class="row align-items-center">
                          ...
                          <div class="col-lg-3 col-md-3">
                              <div class="logo">
                              <img src="<?php echo e(asset('logo/logo09.png')); ?>" alt="">
                                  </a>
                              </div>
                          </div>
                          <!--logo end-->
...
<?php /**PATH D:\BE2\web_ban_quan_ao\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>