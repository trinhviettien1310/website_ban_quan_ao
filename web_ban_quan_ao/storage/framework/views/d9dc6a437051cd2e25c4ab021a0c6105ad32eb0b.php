    ...
    <table class="table message-table" >
      ...
      <tbody>
        ...
        <tr class="<?php if($message->read_at): ?> border-left-success <?php else: ?> bg-light border-left-warning <?php endif; ?>">
          ...
          <td><?php echo e($message->created_at->format('d-m-yy')); ?></td>
          <td>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/backend/message/index.blade.php ENDPATH**/ ?>