...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; <a href="#"></a> <?php echo e(date('Y')); ?>  BY Nguyễn Khánh Tv</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/backend/layouts/footer.blade.php ENDPATH**/ ?>