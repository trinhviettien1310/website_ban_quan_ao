                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                      <div class="footer_widget">
                          ...
                          <div class="footer_widget_contect">
                              <p><i class="fa fa-map-marker" aria-hidden="true"></i><?php echo e($settings->address); ?></p>

                              <p><i class="fa fa-mobile" aria-hidden="true"></i> <?php echo e($settings->phone); ?></p>
                              <a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i>
                                 <?php echo e($settings->email); ?> </a>
                          </div>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                      <div class="footer_widget">
                          ...
                          <ul>
                              ...
                              <li><a href="<?php echo e(route('contact')); ?>"> Thông Tin Liên Hệ</a></li>
                          </ul>
                      </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-6">
...
<?php echo $__env->yieldPushContent('scripts'); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>