    ...
    <div class="card-body">
      <form method="post" action="<?php echo e(route('category.store')); ?>">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" value="<?php echo e(old('title')); ?>" class="form-control">
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/backend/category/create.blade.php ENDPATH**/ ?>