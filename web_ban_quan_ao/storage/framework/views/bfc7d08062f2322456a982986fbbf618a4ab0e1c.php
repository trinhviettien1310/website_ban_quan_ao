                ...
                <div class="select_option">
                    <form action="<?php echo e(route('products-girds-filter')); ?>" method="POST">
                        ...
                        <select name="sort_by" id="short" onchange="this.form.submit()">
                            ...
                            <option value="best-selling" <?php if(!empty($_POST['sort_by']) && $_POST['sort_by'] == 'best-selling'): ?> selected <?php endif; ?>>Bán Chạy Nhất
                            </option>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\web_ban_quan_ao\resources\views/frontend/pages/product-grids.blade.php ENDPATH**/ ?>