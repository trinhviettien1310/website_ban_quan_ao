...
//User login - register
Route::get('login-user', 'LoginCustomController@login')->name('login-user');
Route::post('custom-login','LoginCustomController@customLogin')->name('login.custom'); 
Route::get('registration-user', 'LoginCustomController@registration')->name('register-user');
Route::post('custom-registration', 'LoginCustomController@customRegistration')->name('register.custom'); 
Route::get('signout', 'LoginCustomController@signOut')->name('signout');